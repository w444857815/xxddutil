package com.dxhy.order.config.redis;
...
public class RedisUtil {
     ...
     * @return
     */
    public <T> T lGetByIndex(String key,long index){
        try {
     ...
     * @return
     */
    public <T> boolean rpushList(String key, List<T> value) {
        try {
            Long i = redisTemplate.opsForList().rightPushAll(key, value);
            return true;
        } catch (Exception e) {
            e.printStackTrace();
            return false;
