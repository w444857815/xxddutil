package com.dxhy.order.model.excelHeads;

import lombok.Getter;

/**
 * 表格导入枚举类，这里指表格的头部列表。
 * 左面是显示，和excel里的表头完全匹配
 * 右面是接受数据用的属性，对应excel包下的实体类的属性。一 一对应
 *
 * @author ZSC-DXHY
...
public enum OrderImportExcelEnum {
    ...
    ORDER_XHFMC("销方名称","xhf_mc"),
    /**
     * 购货方纳税人识别号
     */
    ORDER_XHFNSRSBH("销方税号", "xhf_nsrsbh"),
    /**
     * 购货方地址
     */
    ORDER_XHFDZ("销方地址", "xhf_dz"),
    /**
     * 购货方电话
     */
    ORDER_XHFDH("销方电话", "xhf_dh"),
    ...
    public static OrderImportExcelEnum getCodeValue(String key) {
