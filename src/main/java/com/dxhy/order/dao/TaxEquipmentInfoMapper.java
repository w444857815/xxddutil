...
public interface TaxEquipmentInfoMapper {
     ...
     * @return
     */
    List<TaxEquipmentInfo> queryTaxEquipmentList(@Param("taxEquipmentInfo") TaxEquipmentInfo taxEquipmentInfo, @Param("shList") List<String> shList);
    ...
    TaxEquipmentInfo selectTaxByNsrsbh(@Param("nsrsbh") String xhfNsrsbh);
}
